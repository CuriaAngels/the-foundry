...
holes = [
  // [x, y, diameter]
  [   0,  16,  7.7],   // label 1 — top hole
  [   0,   0, 14],     // label 2 — center big hole
  [ -18, -13, 7.7],    // label 3 — bottom-left big hole
  [  18, -13, 7.7],    // label 4 — bottom-right big hole
  [ -16.5,   0,  4],     // label 5 — left small hole near center
  [  16.5,   0,  4],     // label 6 — right small hole near center
...
pocket_holes = [
  ...
  [ -27.5,  8.3, 3.2],   // label 8 — left top
  [ -27.5,  -7.1, 3.2],  // label 9 — left bottom
  [  27.5,  8.3, 3.2],   // label 10 — right top
  [  27.5,  -7.1, 3.2],  // label 11 — right bottom
];
