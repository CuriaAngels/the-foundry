...
holes = [
  // [x, y, diameter]
  [   0,  17,  7.7],   // label 1 — top hole
  [   0,   0, 14],     // label 2 — center big hole
  [ -15, -13, 7.7],    // label 3 — bottom-left big hole
  [  15, -13, 7.7],    // label 4 — bottom-right big hole
  [ -14.5,   0,  4],     // label 5 — left small hole near center
  [  14.5,   0,  4],     // label 6 — right small hole near center
...
pocket_holes = [
  ...
  [ -27.5,  7.2, 3.2],   // label 8 — left top
  [ -27.5,  -6.6, 3.2],  // label 9 — left bottom
  [  27.5,  7.2, 3.2],   // label 10 — right top
  [  27.5,  -6.6, 3.2],  // label 11 — right bottom
];
